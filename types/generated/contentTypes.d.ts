...
export interface ApiCweCwe extends Schema.CollectionType {
  ...
  attributes: {
    CWECode: Attribute.String;
    CWEName: Attribute.Text;
...
export interface ApiGdprArticleGdprArticle extends Schema.CollectionType {
  ...
  info: {
    ...
    displayName: 'GDPRArticle';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ArticleNumber: Attribute.Integer;
    ArticleName: Attribute.Text;
    patterns: Attribute.Relation<
...
export interface ApiIsoPhaseIsoPhase extends Schema.CollectionType {
  collectionName: 'iso_phases';
  info: {
    singularName: 'iso-phase';
    pluralName: 'iso-phases';
    displayName: 'ISO Phase';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ISOPhaseNumber: Attribute.Decimal;
    ISOPhaseDescription: Attribute.Text;
    patterns: Attribute.Relation<
      'api::iso-phase.iso-phase',
      'manyToMany',
      'api::pattern.pattern'
    >;
    createdAt: Attribute.DateTime;
...
export interface ApiOwaspOwasp extends Schema.CollectionType {
  ...
  attributes: {
    OWASPCode: Attribute.String;
    OWASPName: Attribute.Text;
    patterns: Attribute.Relation<
      'api::owasp.owasp',
      'manyToMany',
      'api::pattern.pattern'
...
export interface ApiPatternPattern extends Schema.CollectionType {
  ...
  attributes: {
    PatternName: Attribute.String;
    Description: Attribute.Text;
    Context: Attribute.Text;
    Problem: Attribute.Text;
    ...
    >;
    pbd_principles: Attribute.Relation<
      'api::pattern.pattern',
      'manyToMany',
      'api::pbd-principle.pbd-principle'
    >;
...
export interface ApiPbdPrinciplePbdPrinciple extends Schema.CollectionType {
  collectionName: 'pbd_principles';
  info: {
    singularName: 'pbd-principle';
    pluralName: 'pbd-principles';
    displayName: 'PBD-Principle';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    PrincipleName: Attribute.Text;
    patterns: Attribute.Relation<
      'api::pbd-principle.pbd-principle',
      'manyToMany',
      'api::pattern.pattern'
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::iso-phase.iso-phase': ApiIsoPhaseIsoPhase;
      'api::mvc.mvc': ApiMvcMvc;
      'api::owasp.owasp': ApiOwaspOwasp;
      'api::pattern.pattern': ApiPatternPattern;
      'api::pbd-principle.pbd-principle': ApiPbdPrinciplePbdPrinciple;
